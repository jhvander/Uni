...
R_swap = np.zeros([10])
for i in range(0,10):
    R_swap[i] = fid.swap_rate_from_zcb_prices(0,0,T_swap[i],"quarterly",T,p)[0]
...
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/vasicek_yield_curve.pdf")
# plt.show()
...
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="upper right",fontsize = 5)
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/vasicek_swap_rate.pdf")
# plt.show()
...
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="upper right",fontsize = 5)
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/vasicek_simul.pdf")
# plt.show()
...
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="upper right",fontsize = 5)
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/vasicek_swaption_price.pdf")
plt.show()
